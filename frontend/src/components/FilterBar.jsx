...
export default function FilterBar({ filters, onChange }) {
    ...
    return (
        <div className="space-y-4">
            ...
            <div>
                <p className="text-xs font-semibold text-ink uppercase tracking-wide mb-1.5 bg-border px-2 py-0.5 rounded">Status</p>
            ...
            <div>
                <p className="text-xs font-semibold text-ink uppercase tracking-wide mb-1.5 bg-border px-2 py-0.5 rounded">Priority</p>
                <div className="flex gap-1.5 flex-wrap">
            ...
            <div>
                <p className="text-xs font-semibold text-ink uppercase tracking-wide mb-1.5 bg-border px-2 py-0.5 rounded">Deadline</p>
            ...
            <div>
                <p className="text-xs font-semibold text-ink uppercase tracking-wide mb-1.5 bg-border px-2 py-0.5 rounded">Scope</p>
                <div className="flex gap-1.5 flex-wrap">
